      ...
      <div className="cv_header-row cv_header-row-2">
        <div>
          <a className="cv_header-a-email" href="" onClick={handleCopyClick}>
            {!copied && (
              <svg
                className="cv_header-svg-clipboard"
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
        ...
        <div className="cv_header-row-2-socials--container">
          <a
            className="cv_header-a-linkedin"
            href="https://github.com/Bruno1084"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            className="cv_header-a-linkedin"
            href="https://www.linkedin.com/in/brunos0sa"
            target="_blank"
          >
            <svg
              className="cv_header-svg-linkedin"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
